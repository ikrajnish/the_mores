    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                <h1 className="text-3xl font-bold text-slate-900">Finance & Revenue</h1>
                <p className="text-slate-500">Track earnings, memberships, and expenses</p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-slate-500">Services + Memberships</p>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <CardContent className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={data.chartData}>
                                    ...
                                    <Bar dataKey="memberships" name="Memberships" stackId="a" fill="#10b981" radius={[4, 4, 0, 0]} />
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent>
                ...
                <DialogFooter>
                    <Button onClick={handleSubmit} disabled={loading}>{loading ? "Adding..." : "Add Expense"}</Button>
                </DialogFooter>
            </DialogContent>
        </Dialog>
    )
